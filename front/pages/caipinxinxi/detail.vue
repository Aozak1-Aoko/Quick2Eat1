	...
	<view class="content">
		<view class="container" :style='{"minHeight":"100%","width":"100%","padding":"0","position":"relative","background":"#F6F7F9","height":"auto"}'>
			...
			<view :style='{"padding":"24rpx","borderRadius":"30rpx","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","height":"auto"}' class="detail-content">
				<view :style='{"margin":"0 0 10rpx","borderColor":"#ccc","alignItems":"center","flexWrap":"wrap","borderWidth":"0","display":"flex","width":"100%","borderStyle":"solid","justifyContent":"space-between","height":"auto"}' class="detail-list-item price priceFavor">
					<view :style='{"display":"flex"}' class="text">
						<view :style='{"color":"#B30000","lineHeight":"80rpx","fontSize":"32rpx"}'>￥</view>
						<view :style='{"color":"#B30000","lineHeight":"80rpx","fontSize":"32rpx"}'>{{detail.price}}</view>
					</view>
				...
				<view :style='{"padding":"10rpx 0","margin":"0 0 10rpx","borderColor":"#ccc","borderWidth":"0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="detail-list-item title">
					<view :style='{"padding":"0 20rpx 0 0","whiteSpace":"nowrap","color":"#000","textAlign":"right","width":"auto","lineHeight":"48rpx","fontSize":"28rpx","fontWeight":"bold"}' class="lable">菜品名称：</view>
					<view :style='{"padding":"0px","margin":"0px","lineHeight":"48rpx","fontSize":"28rpx","color":"#929292"}' class="text" >{{detail.caipinmingcheng}}</view>
				</view>
				<view :style='{"padding":"10rpx 0","margin":"0 0 10rpx","borderColor":"#ccc","borderWidth":"0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="detail-list-item title">
					<view :style='{"padding":"0 20rpx 0 0","whiteSpace":"nowrap","color":"#000","textAlign":"right","width":"auto","lineHeight":"48rpx","fontSize":"28rpx","fontWeight":"bold"}' class="lable">菜品分类：</view>
					<view :style='{"padding":"0px","margin":"0px","lineHeight":"48rpx","fontSize":"28rpx","color":"#929292"}' class="text" >{{detail.caipinfenlei}}</view>
				</view>
				<view :style='{"padding":"10rpx 0","margin":"0 0 10rpx","borderColor":"#ccc","borderWidth":"0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="detail-list-item title">
				...
				<view class="detail-list-item" :style='{"padding":"10rpx 0","margin":"0 0 10rpx","borderColor":"#ccc","borderWidth":"0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"padding":"0 20rpx 0 0","whiteSpace":"nowrap","color":"#000","textAlign":"right","width":"auto","lineHeight":"48rpx","fontSize":"28rpx","fontWeight":"bold"}'>菜品编号：</view>
					<view class="text" :style='{"padding":"0px","margin":"0px","lineHeight":"48rpx","fontSize":"28rpx","color":"#929292"}' >{{detail.caipinbianhao}}</view>
				</view>
				<view class="detail-list-item" :style='{"padding":"10rpx 0","margin":"0 0 10rpx","borderColor":"#ccc","borderWidth":"0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"padding":"0 20rpx 0 0","whiteSpace":"nowrap","color":"#000","textAlign":"right","width":"auto","lineHeight":"48rpx","fontSize":"28rpx","fontWeight":"bold"}'>口味偏好：</view>
					<view class="text" :style='{"padding":"0px","margin":"0px","lineHeight":"48rpx","fontSize":"28rpx","color":"#929292"}' >{{detail.kouweipianhao}}</view>
				</view>
				<view class="detail-list-item" :style='{"padding":"10rpx 0","margin":"0 0 10rpx","borderColor":"#ccc","borderWidth":"0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					...
					<view class="text" :style='{"padding":"0px","margin":"0px","lineHeight":"48rpx","fontSize":"28rpx","color":"#929292"}' style="text-decoration: underline" @tap="merchantClick('shangjiazhanghao')" >{{detail.shangjiazhanghao}}</view>
				</view>
				<view class="detail-list-item" :style='{"padding":"10rpx 0","margin":"0 0 10rpx","borderColor":"#ccc","borderWidth":"0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"padding":"0 20rpx 0 0","whiteSpace":"nowrap","color":"#000","textAlign":"right","width":"auto","lineHeight":"48rpx","fontSize":"28rpx","fontWeight":"bold"}'>联系方式：</view>
					<view class="text" :style='{"padding":"0px","margin":"0px","lineHeight":"48rpx","fontSize":"28rpx","color":"#929292"}' >{{detail.lianxifangshi}}</view>
				</view>
				<view class="detail-list-item" :style='{"padding":"10rpx 0","margin":"0 0 10rpx","borderColor":"#ccc","borderWidth":"0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
				...
				<view class="detail-list-item" :style='{"padding":"10rpx 0","margin":"0 0 10rpx","borderColor":"#ccc","borderWidth":"0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"padding":"0 20rpx 0 0","whiteSpace":"nowrap","color":"#000","textAlign":"right","width":"auto","lineHeight":"48rpx","fontSize":"28rpx","fontWeight":"bold"}'>库存：</view>
					<view class="text" :style='{"padding":"0px","margin":"0px","lineHeight":"48rpx","fontSize":"28rpx","color":"#929292"}' >{{detail.alllimittimes}}</view>
				</view>
				<view class="detail-list-item" :style='{"padding":"10rpx 0","margin":"0 0 10rpx","borderColor":"#ccc","borderWidth":"0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
				...
				<view class="detail-list-item rich" :style='{"margin":"0 0 10rpx","borderColor":"#ccc","borderWidth":"0","display":"flex","width":"100%","borderStyle":"solid","height":"auto","order":"3"}'>
					<view class="lable" :style='{"padding":"0 20rpx 0 0","whiteSpace":"nowrap","color":"#333","textAlign":"right","display":"flex","width":"auto","lineHeight":"48rpx","fontSize":"28rpx","fontWeight":"600"}'>简介：</view>
				...
				<view class="bottom-content bg-white tabbar border shop" :style='{"padding":"20rpx 10rpx","margin":"20rpx 0","borderRadius":"20rpx","flexWrap":"wrap","background":"#EDEDED","display":"flex","width":"100%","height":"auto","order":"1"}'>
					...
					<button :style='{"border":"0","padding":"0 20rpx","margin":"0 10rpx 10rpx 0","color":"#000","background":"#fff","width":"auto","fontSize":"28rpx","lineHeight":"60rpx","height":"60rpx"}' v-if="detail.alllimittimes>0" @tap="onCartTap" class="cu-btn bg-orange round shadow-blur" >加入购物车</button>
					<button :style='{"border":"0","padding":"0 20rpx","margin":"0 10rpx 10rpx 0","color":"#000","background":"#fff","width":"auto","fontSize":"28rpx","lineHeight":"60rpx","height":"60rpx"}' v-if="detail.alllimittimes>0" @tap="onBuyTap">立即购买</button>
	...
	export default {
		...
		methods: {
			...
			async merchantClick(name){
				let res = await this.$api.query('shitangshangjia',{shangjiazhanghao: this.detail.shangjiazhanghao})
				this.$utils.jump(`../shitangshangjia/detail?id=${res.data.id}`)
			},
			onDetailTap(item) {
			...
			async comzanClick(row){
				...
				if(!this.comzanChange(row)){
					...
					await this.$api.update('discusscaipinxinxi',row)
					this.$utils.msg('点赞成功');
				}else {
					row.thumbsupnum--
					let arr = String(row.tuserids).split(',')
			...
			async onCommentTap() {
				...
				this.$utils.jump(`../discusscaipinxinxi/add-or-update?refid=${this.id}`  + '&virtualPay=1' )
			},
			delClick(id){
				let that = this
				uni.showModal({
					...
					async success(res) {
						if(res.confirm){
							await that.$api.del('discusscaipinxinxi',JSON.stringify([id]))
							that.$utils.msg('删除成功')
							that.detail.discussnum--
							await that.$api.update('caipinxinxi',that.detail)
							setTimeout(()=>{
