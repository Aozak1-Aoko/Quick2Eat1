			...
			<view :style='{"minHeight":"100%","width":"100%","padding":"20rpx 20rpx 198rpx","position":"relative","background":"#F6F7F9","height":"auto"}'>
				<view class="cu-bar bg-white search" :style='{"width":"100%","padding":"0","background":"none","display":"flex","height":"auto","order":"1"}'>
					<view :style='{"margin":"0","flex":"1","position":"relative"}' class="search-form round">
						...
						<input placeholder-style="color: #333" :style='{"border":"2rpx solid #FFD128","padding":"12rpx 20rpx 12rpx 80rpx","color":"#333","borderRadius":"0","background":"#fff","width":"100%","lineHeight":"56rpx","fontSize":"28rpx","height":"80rpx"}' v-model="searchForm.caipinmingcheng" type="text" placeholder="菜品名称" ></input>
					</view>
				...
				<view :style='{"padding":"20rpx","margin":"20rpx 0 0","borderRadius":"20rpx 20rpx 0 0","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","justifyContent":"space-between"}'>
					<view @click="sortClick('price')" :style='{"border":"0","padding":"0 12rpx","margin":"0 8rpx 0 0","outline":"0","borderRadius":"8rpx","background":"none","display":"flex"}'>
						<text :style='{"color":"#000","lineHeight":"48rpx","fontSize":"24rpx"}'>价格</text>
						<text v-if="listSort!='price'" class="icon iconfont icon-xiaoliang17" :style='{"margin":"0 0 0 8rpx","lineHeight":"48rpx","fontSize":"24rpx","color":"#000"}'></text>
						<text v-else-if="listSort=='price'&&listOrder=='asc'" class="icon iconfont icon-xiaoliang17" :style='{"margin":"0 0 0 8rpx","lineHeight":"48rpx","fontSize":"24rpx","color":"#000"}'></text>
						<text v-else-if="listSort=='price'&&listOrder=='desc'" class="icon iconfont icon-xiaoliang17" :style='{"margin":"0 0 0 8rpx","lineHeight":"48rpx","fontSize":"24rpx","color":"#000"}'></text>
					</view>
						...
						<block v-for="(list,indexOut) in lists" :key="indexOut">
							<block v-for="(product,index) in list" :key="index">
								<view @tap="onDetailTap(product)" v-if="index%6==0" class="list-item" :style='{"boxShadow":"none","padding":"20rpx","margin":"0 0 20rpx","borderRadius":"20rpx","flexWrap":"wrap","background":"#fff","display":"flex","width":"49%","height":"auto"}'>
									<image :style='{"padding":"0","margin":"0","objectFit":"cover","borderRadius":"20rpx","display":"block","width":"100%","height":"220rpx","order":"10"}' mode="aspectFill" v-if="preHttp(product.tupian)" :src="product.tupian"></image>
									<image :style='{"padding":"0","margin":"0","objectFit":"cover","borderRadius":"20rpx","display":"block","width":"100%","height":"220rpx","order":"10"}' mode="aspectFill" v-else :src="product.tupian?baseUrl+product.tupian.split(',')[0]:''"></image>
									<view :style='{"padding":"0","whiteSpace":"nowrap","overflow":"hidden","color":"#000","width":"100%","lineHeight":"50rpx","fontSize":"30rpx","textOverflow":"ellipsis","fontWeight":"bold"}' class="title">{{product.caipinmingcheng}}</view>
									<view :style='{"padding":"0","whiteSpace":"nowrap","overflow":"hidden","color":"#000","width":"100%","lineHeight":"50rpx","fontSize":"30rpx","textOverflow":"ellipsis","fontWeight":"bold"}' class="title">{{product.caipinfenlei}}</view>
									...
									<view :style='{"padding":"0","color":"red","textAlign":"right","width":"100%","lineHeight":"50rpx","fontSize":"28rpx","fontWeight":"700"}' class="price">￥{{product.price}}</view>
									...
									<view :style='{"padding":"0 20rpx 0 0","order":"4"}'>
										...
										<text :style='{"color":"#959595","lineHeight":"50rpx","fontSize":"24rpx"}'>{{product.shangjiazhanghao}}</text>
									</view>
									...
									<view :style='{"width":"100%","padding":"10rpx 0 0","justifyContent":"space-between","display":"flex","height":"auto","order":"11"}'>
										<view :style='{"display":"flex"}' v-if="(userid && isAuth('caipinxinxi','修改')) || (!userid && isAuthFront('caipinxinxi','修改'))" @tap.stop.proevent="onUpdate" :data-row="product">
										...
										<view :style='{"display":"flex"}' v-if="(userid && isAuth('caipinxinxi','删除')) || (!userid && isAuthFront('caipinxinxi','删除'))" @tap.stop.proevent="onDelete" :data-row="product">
									...
									<!-- #ifndef MP-WEIXIN -->
									<view :style='{"width":"100%","padding":"10rpx 0 0","justifyContent":"space-between","display":"flex","height":"auto","order":"11"}'>
										<view :style='{"display":"flex"}' v-if="(userid && isAuth('caipinxinxi','修改')) || (!userid && isAuthFront('caipinxinxi','修改'))" @tap.stop.proevent="onUpdateTap(product)">
											<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"40rpx","color":"#FFD128","display":"inline-block"}' class="cuIcon-edit"></text>
											<text :style='{"fontSize":"28rpx","lineHeight":"40rpx","color":"#FFD128","display":"inline-block"}'>修改</text>
										</view>
										<view :style='{"display":"flex"}' v-if="(userid && isAuth('caipinxinxi','删除')) || (!userid && isAuthFront('caipinxinxi','删除'))" @tap.stop.proevent="onDeleteTap(product.id)">
											<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"40rpx","color":"#959595","display":"inline-block"}' class="cuIcon-delete"></text>
											<text :style='{"fontSize":"28rpx","lineHeight":"40rpx","color":"#959595","display":"inline-block"}'>删除</text>
										</view>
									</view>
								...
								<view @tap="onDetailTap(product)" v-if="index%6==4" class="list-item" :style='{"boxShadow":"none","padding":"20rpx","margin":"0 0 20rpx","borderRadius":"20rpx","flexWrap":"wrap","background":"#fff","display":"flex","width":"49%","height":"auto"}'>
									<image :style='{"width":"100rpx","objectFit":"cover","borderRadius":"20rpx","display":"block","height":"100rpx","order":"1"}' mode="aspectFill" v-if="preHttp(product.tupian)" :src="product.tupian"></image>
									<image :style='{"width":"100rpx","objectFit":"cover","borderRadius":"20rpx","display":"block","height":"100rpx","order":"1"}' mode="aspectFill" v-else :src="product.tupian?baseUrl+product.tupian.split(',')[0]:''"></image>
									<view class="list-item-body" :style='{"width":"calc(100% - 100rpx)","padding":"0","margin":"0","flexWrap":"wrap","display":"flex","height":"auto"}'>
										<view :style='{"padding":"0","margin":"0","color":"#000","width":"100%","lineHeight":"48rpx","fontSize":"30rpx","fontWeight":"bold"}' class="title">{{product.caipinmingcheng}}</view>
										<view :style='{"padding":"0","margin":"0","color":"#000","width":"100%","lineHeight":"48rpx","fontSize":"30rpx","fontWeight":"bold"}' class="title">{{product.caipinfenlei}}</view>
										...
										<view :style='{"padding":"0 20rpx","margin":"0","color":"red","textAlign":"right","width":"100%","lineHeight":"48rpx","fontSize":"28rpx"}' class="price">￥{{product.price}}</view>
										<view :style='{"padding":"0 20rpx 0 0","order":"5"}'>
											<text class="icon iconfont icon-shijian21" :style='{"margin":"0 4rpx 0 0","lineHeight":"50rpx","fontSize":"24rpx","color":"#959595"}'></text>
				...
				<button :style='{"border":"0","boxShadow":"none","color":"rgb(255, 255, 255)","bottom":"128rpx","right":"128rpx","outline":"none","borderRadius":"100%","background":"#FFD128","width":"80rpx","lineHeight":"80rpx","fontSize":"28rpx","position":"fixed","height":"80rpx","zIndex":"999"}' v-if="userid && isAuth('caipinxinxi','新增')" class="add-btn" @click="onAddTap()">新增</button>
				<button :style='{"border":"0","boxShadow":"none","color":"rgb(255, 255, 255)","bottom":"128rpx","right":"128rpx","outline":"none","borderRadius":"100%","background":"#FFD128","width":"80rpx","lineHeight":"80rpx","fontSize":"28rpx","position":"fixed","height":"80rpx","zIndex":"999"}' v-if="!userid && isAuthFront('caipinxinxi','新增')" class="add-btn" @click="onAddTap()">新增</button>
				...
				<view class="screenBox" :class="screenBoxShow?'screenBoxActive':''">
					<view :style='{"width":"100%","padding":"20rpx 0 20rpx 0","alignItems":"center","justifyContent":"space-around","display":"flex"}'>
						<view :style='{"width":"18%","padding":"0 0 0 20rpx","fontSize":"24rpx"}'>店铺名</view>
						<input :style='{"border":"0","width":"80%","padding":"0 20rpx 0 20rpx","borderRadius":"40rpx","background":"#eee","height":"60rpx"}' placeholder="请输入店铺名" v-model="searchForm.dianpuming">
					</view>
					<view :style='{"width":"100%","padding":"20rpx 0 20rpx 0"}'>
						...
						<view :style='{"width":"100%","alignItems":"center","flexWrap":"wrap","justifyContent":"center","display":"flex"}'>
							<input :style='{"border":"0","borderRadius":"40rpx","textAlign":"center","background":"#eee","width":"40%","lineHeight":"60rpx","height":"60rpx"}' v-model="searchForm.pricestart" placeholder="请输入开始价格">
							<view :style='{"padding":"0 10rpx","fontSize":"20rpx"}'>-</view>
							<input :style='{"border":"0","borderRadius":"40rpx","textAlign":"center","background":"#eee","width":"40%","lineHeight":"60rpx","height":"60rpx"}' v-model="searchForm.priceend" placeholder="请输入结束价格">
						</view>
					</view>
	...
	export default {
		...
		methods: {
			...
			async search(){
				...
				if(this.categoryName!='全部'){
					searchForm.caipinfenlei = '%' + this.categoryName + '%'
				}
				if(this.searchForm.dianpuming){
